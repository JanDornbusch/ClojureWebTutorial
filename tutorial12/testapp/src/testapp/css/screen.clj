...
(def warn-background (rgb 255 255 255))
...
(def guestbook-correct (rgb 0 178 0)) ;; http://www.color-hex.com/color/00b200
(def guestbook-correct-background (rgb 204 239 204)) ;; http://www.color-hex.com/color/ccefcc
...
(defstyles screen
  ...
  [:#main {
       ...
       ;; Change this to 132,121,95,.4 when use png included
